...
let handler = async (m, { conn, args, text, usedPrefix: _p, command, isROwner }) => {
    ...
    //Manage panel
    const domain = "https://frenzy.zrillhosting.cfd" // Domain
const apikey = "ptla_aYg3uz90NH7MHrbkg9ZskueG673AjCK3tvsf4L4tbGk" // Apikey
const c_apikey = "ptlc_YmvDm4GjZjYIg7y1cKycfthjS2r93mAReqAOWcf1OPH" // c Apikey

    const webPage = "https://frenzy.zrillhosting.cfd" // Web Page
...
> Perintah : ${_p + command} nomer/tag`);
            ...
            let f = await fetch(domain + "/api/application/users", {
                ...
                "body": JSON.stringify({
                    "email": "panel" + profil.toString() + "@gmail.com", // Email
                    "username": "user" + profil.toString(), // Username
                    "first_name": "user" + profil.toString(), // Nama Depan
                    "last_name": "user", // Nama Belakang
                    "language": "en", // Bahasa
