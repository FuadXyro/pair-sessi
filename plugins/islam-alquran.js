...
`.trim()
	...
	await conn.sendMessage(m.chat, { audio: { url: res.audio }, seconds: fsizedoc, ptt: true, mimetype: "audio/mpeg", fileName: "vn.mp3", waveform: [100,0,100,0,100,0,100] }, { quoted: m })
	} catch (e) {
	throw eror
	}
};
