...
`.trim()
  ...
  await conn.reply(m.chat, caption, fpay, { contextInfo: { isForwarded: true, forwardingScore: 9999, externalAdReply :{ mediaType: 1, mediaUrl: kled, title: `Bank Cek`, thumbnail: { url: kled }, thumbnailUrl: kled, renderLargerThumbnail: true }}})
}
handler.help = ['bank']
handler.tags = ['rpg']
